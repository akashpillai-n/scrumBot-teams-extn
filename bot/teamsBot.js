  ...
  constructor() {
    ...
    this.onMessage(async (context, next) => {
      ...
      switch (txt) {
        ...
        case "dumdum": {
          await context.sendActivity(`This here is our custom response !!`);
          break;
        }
        ...
        case "cats": {
          try {
            ...
            const messageText = `Here is a fact about cats:\n ${JSON.stringify(responseData.fact)}`;
            await context.sendActivity(messageText);
          } catch (error) {
            console.error(error);
            await context.sendActivity("Sorry, there was an error fetching the data.");
          }
          break;
        }
